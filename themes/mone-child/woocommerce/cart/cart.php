					...
					<tfoot>
						<tr>
							<td colspan="6" class="px-0">
								<div class="form-group discountCouponForm mx-auto position-relative">
									<input type="text" name="coupon_code" class="input-text form-control" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Ihr Gutschein...', 'woocommerce' ); ?>" />
									<!-- <button type="submit" class="wcCtBtnTwo">Apply Coupon</button> -->
									<button type="submit" class="wcCtBtnFour button position-absolute" name="apply_coupon" value="<?php esc_attr_e( 'Apply Coupon', 'woocommerce' ); ?>"><?php esc_attr_e( 'Gutschein einlösen', 'woocommerce' ); ?></button>
								</div>
							</td>					
						</tr>
							...
							<td colspan="6" class="border-0 p-0">
								<div id="updateAndReturnShop" class="row flex-md-row-reverse">
									<div class="col-md-6 text-center text-md-right">
										<button type="submit" class="wcCtBtnThree forPadding text-uppercase button" name="update_cart" value="<?php esc_attr_e( 'Update Shopping Cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Warenkorb aktualisieren', 'woocommerce' ); ?></button>
									...
									<div class="col-md-6 text-center text-md-left mt-2 mt-md-0">
										<button class="wcCtBtnThree text-uppercase">
											<a href="<?php echo esc_url(home_url('/')); ?>/shop/">										
												<i class="fa fa-angle-double-left"></i> Bestellung fortsetzen
											</a>
										</button>
									</div>
								</div>
